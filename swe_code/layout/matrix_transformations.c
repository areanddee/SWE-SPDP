...
fType* pad_2D_fp_arr(fType* var, int dim1, int padded_dim1, int dim2, int padded_dim2) {
  int i,j;
    ...
    for (i = 0; i < padded_dim1; i++) {
        for (j = 0; j < padded_dim2; j++) {
...
fType* tile_2D_fp_arr(fType* arr, int dim1, int dim2, int dim2_tiled) {
  int i,j,k;
    ...
    for (i = 0; i < n_tiles; i++) {		// iterate through each tile
        for (j = 0; j < dim1; j++) {		// iterate through each row
            for (k = 0; k < dim2_tiled; k++) {		// iterate through each column
